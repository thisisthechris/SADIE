...
PLYMOUTH_POSTCODES = [
    ...
    ("PL1 1", "City Centre", 18),
    ("PL1 2", "Barbican & Hoe", 14),
    ("PL1 3", "Millbay & Stonehouse", 10),
    ("PL1 4", "Devonport", 9),
    ("PL1 5", "Stoke & Pennycomequick", 8),
    # Inner suburbs
    ("PL2 1", "North Prospect", 6),
    ("PL2 2", "Ford & Keyham", 5),
    ("PL2 3", "Peverell", 8),
    ("PL3 4", "Crownhill", 5),
    ("PL3 5", "Mannamead", 6),
    ("PL3 6", "Mutley", 9),
    ("PL4 0", "Greenbank & Lipson", 8),
    ("PL4 6", "Lipson Vale", 5),
    ("PL4 7", "Laira", 4),
    ("PL4 8", "North Hill", 6),
    ("PL4 9", "Freedom Fields", 5),
    # Outer suburbs
    ("PL5 1", "Whitleigh", 4),
    ("PL5 2", "Southway", 4),
    ("PL5 3", "Tamerton Foliot", 3),
    ("PL5 4", "Derriford", 5),
    ("PL6 5", "Roborough", 4),
    ("PL6 6", "Woolwell", 3),
    ("PL6 7", "Leigham & Mainstone", 4),
    ("PL6 8", "Plympton", 6),
    ("PL7 1", "Plympton St Maurice", 4),
    ("PL7 4", "Plymstock", 5),
    ("PL9 7", "Elburton", 4),
    ("PL9 8", "Plymstock Broadway", 4),
    ("PL9 9", "Turnchapel", 3),
    # Extended suburbs & nearby towns
    ("PL8", "Liskeard", 2),
    ("PL13", "Looe", 2),
    ("PL14", "Bodmin", 2),
    ("PL15", "Mevagissey", 1),
